...
#SBATCH -J "training_ms_marco_v2_bert_32_job"  # name of the job
#SBATCH --output="logs/training_ms_marco_v2_bert_32_job-%j.out"    # output file name (std out)
#SBATCH --error="logs/training_ms_marco_v2_bert_32_job-%j.err"     # error file name (std err)

...
#SBATCH -J "training_final_harry_potter_wo_opt_job"  # name of the job
#SBATCH --output="logs/training_final_harry_potter_wo_opt_job-%j.out"    # output file name (std out)
#SBATCH --error="logs/training_final_harry_potter_wo_opt_job-%j.err"     # error file name (std err)
...
# dataset arguments
DATASET_NAME="final_harry_potter_wo_opt"
DATASET_MODE="QQP"

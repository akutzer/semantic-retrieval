...
#SBATCH -J "L2_normalized"  # name of the job
#SBATCH --output="L2_normalized_%j.out"    # output file name (std out)
#SBATCH --error="L2_normalized_%j.err"     # error file name (std err)

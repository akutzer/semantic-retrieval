...
#SBATCH -J "training_ms_marco_v2_bert_L2_normalized.job"  # name of the job
#SBATCH --output="training_ms_marco_v2_bert_L2_normalized.job-%j.out"    # output file name (std out)
#SBATCH --error="training_ms_marco_v2_bert_L2_normalized.job-%j.err"     # error file name (std err)

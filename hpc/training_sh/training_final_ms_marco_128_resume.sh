...
#SBATCH -J "training_ms_marco_v2_final_128_resume_job"  # name of the job
#SBATCH --output="logs/training_ms_marco_v2_final_128_resume_job-%j.out"    # output file name (std out)
#SBATCH --error="logs/training_ms_marco_v2_final_128_resume_job-%j.err"     # error file name (std err)
...
# dataset arguments
DATASET_NAME="final_ms_marco_v2_resume"
DATASET_MODE="QPP"
...
CHECKPOINT="../checkpoints/final_ms_marco_v2_roberta_cosine_128_2023-06-17T20:04:32.073/epoch5_6_loss1.2608_mrr0.7029_acc53.655/"

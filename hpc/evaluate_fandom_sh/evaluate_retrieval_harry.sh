...
#SBATCH -J "fandom_harry"  # name of the job
#SBATCH --output="fandom_harry_%j.out"    # output file name (std out)
#SBATCH --error="fandom_harry_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/harry_potter_final/epoch6_1_loss0.1000_mrr0.9817_acc96.391"

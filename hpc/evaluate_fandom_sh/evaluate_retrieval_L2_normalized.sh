...
#SBATCH -J "fandom_L2_normalized"  # name of the job
#SBATCH --output="fandom_L2_normalized_%j.out"    # output file name (std out)
#SBATCH --error="fandom_L2_normalized_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_L2_normalized/epoch3_2_loss1.2830_mrr0.6993_acc52.660"

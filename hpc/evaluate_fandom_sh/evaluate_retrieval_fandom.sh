...
#SBATCH -J "fandom_fandom"  # name of the job
#SBATCH --output="fandom_fandom_%j.out"    # output file name (std out)
#SBATCH --error="fandom_fandom_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/fandoms_all_final/epoch4_1_loss0.0849_mrr0.9844_acc96.942"

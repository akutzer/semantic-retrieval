...
#SBATCH -J "fandom_roberta"  # name of the job
#SBATCH --output="fandom_roberta_%j.out"    # output file name (std out)
#SBATCH --error="fandom_roberta_%j.err"     # error file name (std err)

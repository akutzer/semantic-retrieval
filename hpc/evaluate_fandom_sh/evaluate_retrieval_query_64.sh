...
#SBATCH -J "fandom_query_64"  # name of the job
#SBATCH --output="fandom_query_64_%j.out"    # output file name (std out)
#SBATCH --error="fandom_query_64_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_query_64/epoch3_2_loss1.2786_mrr0.7000_acc53.038"

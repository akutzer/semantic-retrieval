...
#SBATCH -J "f_fandom_all_24"  # name of the job
#SBATCH --output="f_fandom_all_24_%j.out"    # output file name (std out)
#SBATCH --error="f_fandom_all_24_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../../../data/checkpoint/fandom_all_24/epoch4_1_loss0.0849_mrr0.9844_acc96.942"

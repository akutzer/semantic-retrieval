...
#SBATCH -J "m_final_roberta_24"  # name of the job
#SBATCH --output="m_final_roberta_24_%j.out"    # output file name (std out)
#SBATCH --error="m_final_roberta_24_%j.err"     # error file name (std err)
...
QUERIES_PATH="../../../../data/fandoms_qa/harry_potter/test/queries.tsv"
TRIPLES_PATH="../../../../data/fandoms_qa/harry_potter/test/triples.tsv"
# INDEX_PATH="../../../../data/passages.colbert.indices.pt"

CHECKPOINT_PATH="../../../../data/checkpoint/ms_marco_v2_final_roberta_24/epoch5_6_loss1.2808_mrr0.6965_acc53.049"

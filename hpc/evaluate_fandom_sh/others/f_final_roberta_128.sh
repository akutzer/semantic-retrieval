...
#SBATCH -J "fandom_final_128"  # name of the job
#SBATCH --output="fandom_final_128_%j.out"    # output file name (std out)
#SBATCH --error="fandom_final_128_%j.err"     # error file name (std err)
...
QUERIES_PATH="../../data/fandoms_qa/fandoms_all/val/queries.tsv"
TRIPLES_PATH="../../data/fandoms_qa/fandoms_all/val/triples.tsv"
# INDEX_PATH="../../data/fandoms_qa/fandoms_all/all/passages.index.pt"

CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_final_roberta_128/epoch5_6_loss1.2608_mrr0.7029_acc53.655"

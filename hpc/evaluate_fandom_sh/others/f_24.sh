...
#SBATCH -J "fandom_24"  # name of the job
#SBATCH --output="fandom_24_%j.out"    # output file name (std out)
#SBATCH --error="fandom_24_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_24/epoch4_2_loss1.2986_mrr0.6948_acc52.451"

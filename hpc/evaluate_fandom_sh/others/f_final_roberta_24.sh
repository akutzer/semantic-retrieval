...
#SBATCH -J "fandom_final_24"  # name of the job
#SBATCH --output="fandom_final_24_%j.out"    # output file name (std out)
#SBATCH --error="fandom_final_24_%j.err"     # error file name (std err)

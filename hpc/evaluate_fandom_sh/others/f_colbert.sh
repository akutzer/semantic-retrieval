...
#SBATCH -J "fandom_colbert"  # name of the job
#SBATCH --output="fandom_colbert_%j.out"    # output file name (std out)
#SBATCH --error="fandom_colbert_%j.err"     # error file name (std err)

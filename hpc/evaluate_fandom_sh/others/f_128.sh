...
#SBATCH -J "fandom_128"  # name of the job
#SBATCH --output="fandom_128_%j.out"    # output file name (std out)
#SBATCH --error="fandom_128_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_128/epoch3_2_loss1.2828_mrr0.6986_acc52.852"

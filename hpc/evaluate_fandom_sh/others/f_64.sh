...
#SBATCH -J "fandom_64"  # name of the job
#SBATCH --output="fandom_64_%j.out"    # output file name (std out)
#SBATCH --error="fandom_64_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_64/epoch3_2_loss1.2838_mrr0.6973_acc52.680"

...
#SBATCH -J "fandom_32"  # name of the job
#SBATCH --output="fandom_32_%j.out"    # output file name (std out)
#SBATCH --error="fandom_32_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_32/epoch3_2_loss1.2895_mrr0.6943_acc52.262"

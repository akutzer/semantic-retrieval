...
#SBATCH -J "marco_roberta"  # name of the job
#SBATCH --output="marco_roberta_%j.out"    # output file name (std out)
#SBATCH --error="marco_roberta_%j.err"     # error file name (std err)

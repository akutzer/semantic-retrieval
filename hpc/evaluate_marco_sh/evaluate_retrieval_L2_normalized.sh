...
#SBATCH -J "marco_L2_normalized"  # name of the job
#SBATCH --output="marco_L2_normalized_%j.out"    # output file name (std out)
#SBATCH --error="marco_L2_normalized_%j.err"     # error file name (std err)

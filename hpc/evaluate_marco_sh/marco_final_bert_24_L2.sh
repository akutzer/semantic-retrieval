...
#SBATCH -J "m_final_bert_24_L2"  # name of the job
#SBATCH --output="m_final_bert_24_L2_%j.out"    # output file name (std out)
#SBATCH --error="m_final_bert_24_L2_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_final_bert_24_L2/epoch5_6_loss1.2992_mrr0.6948_acc52.088"

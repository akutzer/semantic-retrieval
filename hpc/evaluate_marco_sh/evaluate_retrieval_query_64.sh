...
#SBATCH -J "marco_query_64"  # name of the job
#SBATCH --output="marco_query_64_%j.out"    # output file name (std out)
#SBATCH --error="marco_query_64_%j.err"     # error file name (std err)

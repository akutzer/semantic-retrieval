...
#SBATCH -J "m_final_bert_128"  # name of the job
#SBATCH --output="m_final_bert_128_%j.out"    # output file name (std out)
#SBATCH --error="m_final_bert_128_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../../data/checkpoint/ms_marco_v2_final_bert_128/epoch5_6_loss1.2878_mrr0.6967_acc53.026"

...
#SBATCH -J "m_final_bert_128_L2"  # name of the job
#SBATCH --output="m_final_bert_128_L2_%j.out"    # output file name (std out)
#SBATCH --error="m_final_bert_128_L2_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../../data/checkpoint/ms_marco_v2_final_bert_128_L2/epoch5_5_loss1.2810_mrr0.6995_acc52.570"

...
#SBATCH -J "marco_final_128"  # name of the job
#SBATCH --output="marco_final_128_%j.out"    # output file name (std out)
#SBATCH --error="marco_final_128_%j.err"     # error file name (std err)

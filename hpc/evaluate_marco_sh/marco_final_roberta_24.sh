...
#SBATCH -J "marco_final_roberta_24"  # name of the job
#SBATCH --output="marco_final_roberta_24_%j.out"    # output file name (std out)
#SBATCH --error="marco_final_roberta_24_%j.err"     # error file name (std err)

...
#SBATCH -J "marco_colbert"  # name of the job
#SBATCH --output="marco_colbert_%j.out"    # output file name (std out)
#SBATCH --error="marco_colbert_%j.err"     # error file name (std err)

...
#SBATCH -J "ms_marco_v2_roberta"  # name of the job
#SBATCH --output="retriever_ms_marco_v2_roberta_%j.out"    # output file name (std out)
#SBATCH --error="retriever_ms_marco_v2_roberta_%j.err"     # error file name (std err)
...
CHECKPOINT_PATH="../../data/checkpoint/ms_marco_v2_roberta/epoch4_2_loss1.2602_mrr0.7049_acc53.571"

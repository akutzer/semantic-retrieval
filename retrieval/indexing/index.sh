...
PASSAGES_PATH = "../../data/fandoms_qa/fandoms_all/human_verified/final/witc/all/passages_test.tsv"
INDEX_PATH = "../../data/fandoms_qa/fandoms_all/human_verified/final/witc/all/passages_test.index.pt"

...
for VERSION in ["v1.1", "v2.1"]:
    ...
    DATASET_DIR = f"../../data/ms_marco/{DATASET}_{VERSION.replace('.', '_')}"
    ...
    for dataset_type, dataset  in datasets.items():
        ...
        triples_path = os.path.join(SUB_DATASET_DIR, f"triples.{MODE.lower()}")
        queries_path = os.path.join(SUB_DATASET_DIR, f"queries.{MODE.lower()}")
        passages_path = os.path.join(SUB_DATASET_DIR, f"passages.{MODE.lower()}")

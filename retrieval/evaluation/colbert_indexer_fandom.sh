...
#SBATCH --output="indexer_fandom_job-%j.out"    # output file name (std out)
#SBATCH --error="indexer_fandom_job-%j.err"     # error file name (std err)
